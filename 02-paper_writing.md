...
- 《心理学报》《心理科学进展》《心理科学》《应用心理学》《中国临床心理学杂志》的投稿指南及自检报告（网站上一般可下载）。
...
格式的训练，是初学论文写作的一大难关。国内心理学专业的毕业论文，基本上遵循美国心理学会（APA）的格式，以下称为APA格式。这一格式的具体要求，在前述《心理与教育论文写作》中有明确交待，在《心理科学进展》的“下载中心”的“参考文献著录要求”中，也有仔细说明，此文档另放在本目录下。

此外，Word的使用也是一个基本操作。绝大多数同学还未掌握如何设置不同页眉、不同页码（如摘要要求希腊页码，正文要求阿拉伯数字页码），分不清分页符和分节符的功能，分不清En Dash符号和Hyphen符号及其插入方式。这需要自行系统学习。
